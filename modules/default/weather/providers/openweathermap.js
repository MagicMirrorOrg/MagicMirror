...
WeatherProvider.register("openweathermap", {
	...
	generateWeatherObjectsFromForecast(forecasts) {
		...
		return [new WeatherObject(this.config.units, this.config.tempUnits, this.config.windUnits)];
	},
	...
	generateWeatherObjectsFromOnecall(data) {
		...
		return { current: new WeatherObject(this.config.units, this.config.tempUnits, this.config.windUnits), hours: [], days: [] };
	},
