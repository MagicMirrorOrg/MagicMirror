...
function Server (config) {
	...
	this.open = function () {
		return new Promise((resolve) => {
			...
			let directories = ["/config", "/css", "/favicon.svg", "/default", "/modules", "/node_modules/animate.css", "/node_modules/@fontsource", "/node_modules/@fortawesome", "/translations", "/tests/configs", "/tests/mocks"];
