...
- Added the ability to omit the temperature label and weather icon from the view of the `currentweather` module. This is useful in case one wants to use only wind and/or sunset/rise information. 
